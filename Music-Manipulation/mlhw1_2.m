...
[audioA, fsA] = audioread('hw1materials/Audio/silentnight_piano.aif');
[audioB, fsB] = audioread('hw1materials/Audio/silentnight_guitar.aif');
[audioC, fsC] = audioread('hw1materials/Audio/littlestar_piano.aif');
